...
async def send_farsi_about(message: Message):
    ...
    about_part3 = (
        ...
        "• 🟢 ۵۰٪ سالانه: برای سرمایه ۵۰۰ تا ۵,۰۰۰ دلار\n"
        "• 🔵 ۶۰٪ سالانه: برای سرمایه ۵,۰۰۰ تا ۱۰,۰۰۰ دلار\n"
        "• 🟣 ۷۰٪ سالانه: برای سرمایه بالای ۱۰,۰۰۰ دلار\n\n"
        
        "💰 **محاسبه پرداخت ماهانه:**\n"
        "(سود سالانه تقسیم بر ۱۲ ماه)\n"
        "• 🟢 ~۴.۱۷٪ ماهانه (برای ۵۰٪ سالانه)\n"
        "• 🔵 ~۵٪ ماهانه (برای ۶۰٪ سالانه)\n"
        "• 🟣 ~۵.۸۳٪ ماهانه (برای ۷۰٪ سالانه)\n\n"
...
async def send_english_about(message: Message):
    ...
    about_part3 = (
        ...
        "• 🟢 50% annually: For $500 to $5,000 investment\n"
        "• 🔵 60% annually: For $5,000 to $10,000 investment\n"
        "• 🟣 70% annually: For over $10,000 investment\n\n"
        
        "💰 **Monthly Payout Calculation:**\n"
        "(Annual rate divided by 12 months)\n"
        "• 🟢 ~4.17% monthly (for 50% annually)\n"
        "• 🔵 ~5% monthly (for 60% annually)\n"
        "• 🟣 ~5.83% monthly (for 70% annually)\n\n"
...
async def send_arabic_about(message: Message):
    ...
    about_part3 = (
        ...
        "💰 **حساب الدفع الشهري:**\n"
        "(المعدل السنوي مقسوم على ١٢ شهر)\n"
        "• 🟢 ~٤.١٧٪ شهرياً (لـ ٥٠٪ سنوياً)\n"
        "• 🔵 ~٥٪ شهرياً (لـ ٦٠٪ سنوياً)\n"
        "• 🟣 ~٥.٨٣٪ شهرياً (لـ ٧٠٪ سنوياً)\n\n"
